...
export const AccordianItem = ({className, children}) => {
	...
	return (
		<AccordianItemStyle className={className}>
			<HeaderWrap toggle={toggle} onClick={() => _handleClick()}>
				<H4>{header}</H4>
				<ToggleIcon toggle={toggle} src={Icons.chevronPurple} />
			</HeaderWrap>
			<ContentWrap toggle={toggle}>{content}</ContentWrap>
		</AccordianItemStyle>
	)
}
