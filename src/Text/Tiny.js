...
export const Tiny = ({children, className, width, textAlign, weight, color}) => {
	return (
		<TinyStyle className={className} width={width} weight={weight} textAlign={textAlign} color={color}>
			{children}
		</TinyStyle>
	)
}
