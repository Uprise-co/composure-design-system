...
export const Note = ({children, className, width, textAlign, weight, color}) => {
	return (
		<NoteStyle className={className} width={width} weight={weight} textAlign={textAlign} color={color}>
			{children}
		</NoteStyle>
	)
}
