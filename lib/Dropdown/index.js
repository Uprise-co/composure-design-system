...
export const Dropdown = ({
  ...
  }, title ? /*#__PURE__*/React.createElement(LabelWrapper, getLabelProps(), title) : null, /*#__PURE__*/React.createElement(TriggerButtonContainer, null, /*#__PURE__*/React.createElement(TriggerButton, getToggleButtonProps({
    type: "button"
  }), selectedItem && selectedItem.label || label, /*#__PURE__*/React.createElement(ArrowIcon, {
    isOpen: isOpen
  }))), /*#__PURE__*/React.createElement(MenuList, _extends({}, getMenuProps(), {
    style: menuStyle
