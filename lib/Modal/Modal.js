...
import { backgrounds } from "uprise-uikit/colors"; // Components

import { H4 } from "components/ui/Headings"; // icons
...
export const Modal = ({
  ...
  if (showModal) {
    ...
    /*#__PURE__*/
    React.createElement(ModalWrapper, _extends({}, props, {
    ...
    /*#__PURE__*/
    React.createElement(Background, null))), modalRoot);
  } else {
    return null;
  }
