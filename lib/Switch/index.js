...
export const Switch = ({
  ...
  return /*#__PURE__*/React.createElement(SwitchStyle, null, /*#__PURE__*/React.createElement(ToggleLeftStyle, {
    active: leftActive,
    onClick: !leftActive ? () => handleClick() : null
  }, leftLabel), /*#__PURE__*/React.createElement(ToggleRightStyle, {
    active: !leftActive,
    onClick: leftActive ? () => handleClick() : null
  }, rightLabel));
};
