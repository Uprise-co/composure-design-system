...
import moment from "moment-timezone"; // UI
...
export const TaskButton = ({
  ...
  return /*#__PURE__*/React.createElement(TaskStyle, {
    key: index,
    last: last,
    active: active,
    onClick: () => handleClick()
    ...
    last: last
  }, /*#__PURE__*/React.createElement(TaskLeftStyle, null, /*#__PURE__*/React.createElement(IconLeftImage, {
    src: iconLeft
  }), /*#__PURE__*/React.createElement(TaskTextStyle, null, /*#__PURE__*/React.createElement(H6, {
    className: "m-b-0 m-t-0"
  }, title), subTitle && /*#__PURE__*/React.createElement(H6, {
    className: "m-b-0 m-t-0",
    weight: "normal"
  }, subTitle), /*#__PURE__*/React.createElement(Tiny, {
    className: `${last ? "m-b-0 m-t-0 " : "m-b-3 m-t-0 "}`
  }, type === "bonus" || type === "homework" || type === "lessons" ? moment(task.time, "HH:mm:ss").format("mm:ss") + " min" : ""))), /*#__PURE__*/React.createElement(TaskRightStyle, null, task.taskId && ((_activity$task$taskId = activity[task.taskId]) === null || _activity$task$taskId === void 0 ? void 0 : _activity$task$taskId.completed) && /*#__PURE__*/React.createElement(IconRightImage, {
