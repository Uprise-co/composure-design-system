!function (t, e) {
  ...
  (n < 2 || 2 == n && o < 6) && D("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + i.version + ". See momentjs.com"), d.prototype = {
    _set: function (t) {
  ...
  }, T.version = "0.5.31", T.dataVersion = "", T._zones = s, T._links = f, T._names = a, T._countries = u, T.add = S, T.link = j, T.load = function (t) {
    S(t.zones), j(t.links), function (t) {
      var e, n, o, r;
  ...
  }, T.zone = M, T.zoneExists = function t(e) {
  ...
  i.tz = T, i.defaultZone = null, i.updateOffset = function (t, e) {
    var n,
        o = i.defaultZone;
    if (void 0 === t._z && (o && A(t) && !t._isUTC && (t._d = i.utc(t._a)._d, t.utc().add(o.parse(t), "minutes")), t._z = o), t._z) if (n = t._z.utcOffset(t), Math.abs(n) < 16 && (n /= 60), void 0 !== t.utcOffset) {
      var r = t._z;
