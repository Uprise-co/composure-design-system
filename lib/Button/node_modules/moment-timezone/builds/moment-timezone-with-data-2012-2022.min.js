!function (a, i) {
  ...
  var i,
      ...
      s = {},
      u = {};
  c && "string" == typeof c.version || N("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/");
  ...
  function p(a) {
    var i = a.split("|"),
        ...
        r = i[3].split(""),
        o = i[4].split(" ");
    return f(e), f(r), f(o), function (a, i) {
  ...
  function z() {
    ...
    for (var e, r, o = E(), c = o.length, A = function (a) {
      for (var i, e, r = a.length, o = {}, c = [], A = 0; A < r; A++) for (i in e = u[a[A].offset] || {}) e.hasOwnProperty(i) && (o[i] = !0);

      for (A in o) o.hasOwnProperty(A) && c.push(s[A]);

      return c;
    }(o), n = [], t = 0; t < A.length; t++) {
      for (e = new h(S(A[t])), r = 0; r < c; r++) e.scoreOffsetAt(o[r]);
  ...
  function T(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) o = P(e = (r = a[i].split("|"))[0]), A[o] = a[i], s[o] = e, function (a, i) {
      var e, r;
  ...
  function k(a) {
    T(a.zones), _(a.links), function (a) {
      var i, e, r, o;
      if (a && a.length) for (i = 0; i < a.length; i++) e = (o = a[i].split("|"))[0].toUpperCase(), r = o[1].split(" "), t[e] = new d(e, r);
    }(a.countries), G.dataVersion = a.version;
  }

  function C(a) {
    return C.didShowError || (C.didShowError = !0, N("moment.tz.zoneExists('" + a + "') has been deprecated in favor of !moment.tz.zone('" + a + "')")), !!S(a);
  }
  ...
  function G(a) {
    ...
    return r && !c.isMoment(a) && B(o) && o.add(r.parse(o), "minutes"), o.tz(e), o;
  }

  (e < 2 || 2 == e && r < 6) && N("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"), M.prototype = {
    _set: function (a) {
    ...
    parse: function (a) {
      for (var i, e, r, o = +a, c = this.offsets, A = this.untils, n = A.length - 1, t = 0; t < n; t++) if (i = c[t], e = c[t + 1], r = c[t ? t - 1 : t], i < e && G.moveAmbiguousForward ? i = e : r < i && G.moveInvalidForward && (i = r), o < A[t] - 6e4 * i) return c[t];
  ...
  }, G.version = "0.5.33", G.dataVersion = "", G._zones = A, G._links = n, G._names = s, G._countries = t, G.add = T, G.link = _, G.load = k, G.zone = S, G.zoneExists = C, G.guess = function (a) {
    return i && !a || (i = z()), i;
  }, G.names = function () {
    var a,
        i = [];
    ...
    return i.sort();
  }, G.Zone = M, G.unpack = p, G.unpackBase60 = o, G.needsOffset = B, G.moveInvalidForward = !0, G.moveAmbiguousForward = !1, G.countries = function () {
