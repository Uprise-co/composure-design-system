!function (a, i) {
  ...
  function P() {
    ...
    var e,
      ...
      for (e = 1; e < 48; e++) (i = new d(new Date(r, e, 1))).offset !== o.offset && (a = E(o, i), c.push(a), c.push(new d(new Date(a.at + 6e4)))), o = i;
  ...
  function C(a) {
    T(a.zones), k(a.links), function (a) {
      var i, e, r, o;
  ...
  (e < 2 || 2 == e && r < 6) && N("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"), M.prototype = {
    ...
    parse: function (a) {
      ...
      for (o = 0; o < t; o++) if (i = A[o], e = A[o + 1], r = A[o ? o - 1 : o], i < e && G.moveAmbiguousForward ? i = e : r < i && G.moveInvalidForward && (i = r), c < n[o] - 6e4 * i) return A[o];
  ...
  }, G.version = "0.5.31", G.dataVersion = "", G._zones = A, G._links = n, G._names = s, G._countries = t, G.add = T, G.link = k, G.load = C, G.zone = _, G.zoneExists = function a(i) {
    return a.didShowError || (a.didShowError = !0, N("moment.tz.zoneExists('" + i + "') has been deprecated in favor of !moment.tz.zone('" + i + "')")), !!_(i);
  }, G.guess = function (a) {
    return i && !a || (i = P()), i;
  }, G.names = function () {
    var a,
  ...
  c.tz = G, c.defaultZone = null, c.updateOffset = function (a, i) {
    var e,
        r = c.defaultZone;
    if (void 0 === a._z && (r && B(a) && !a._isUTC && (a._d = c.utc(a._a)._d, a.utc().add(r.parse(a), "minutes")), a._z = r), a._z) if (e = a._z.utcOffset(a), Math.abs(e) < 16 && (e /= 60), void 0 !== a.utcOffset) {
      var o = a._z;
    ...
    if (a) {
      ...
      return this._z = _(a), this._z ? c.updateOffset(this, i) : N("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }
    ...
    return (e < 2 || 2 == e && r < 9) && N("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + c.version + "."), c.defaultZone = a ? _(a) : null, c;
  };
