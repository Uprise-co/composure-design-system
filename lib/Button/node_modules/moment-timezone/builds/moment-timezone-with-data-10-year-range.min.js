!function (a, i) {
  ...
  function P() {
    ...
    var e,
      ...
      for (e = 1; e < 48; e++) (i = new b(new Date(r, e, 1))).offset !== o.offset && (a = g(o, i), c.push(a), c.push(new b(new Date(a.at + 6e4)))), o = i;
  ...
  (e < 2 || 2 == e && r < 6) && O("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"), M.prototype = {
    ...
    parse: function (a) {
      ...
      for (o = 0; o < t; o++) if (i = A[o], e = A[o + 1], r = A[o ? o - 1 : o], i < e && L.moveAmbiguousForward ? i = e : r < i && L.moveInvalidForward && (i = r), c < n[o] - 6e4 * i) return A[o];
  ...
  }, L.version = "0.5.31", L.dataVersion = "", L._zones = A, L._links = n, L._names = s, L._countries = t, L.add = T, L.link = k, L.load = B, L.zone = _, L.zoneExists = function a(i) {
    return a.didShowError || (a.didShowError = !0, O("moment.tz.zoneExists('" + i + "') has been deprecated in favor of !moment.tz.zone('" + i + "')")), !!_(i);
  }, L.guess = function (a) {
    return i && !a || (i = P()), i;
  }, L.names = function () {
    var a,
  ...
  c.tz = L, c.defaultZone = null, c.updateOffset = function (a, i) {
    var e,
        r = c.defaultZone;
    if (void 0 === a._z && (r && C(a) && !a._isUTC && (a._d = c.utc(a._a)._d, a.utc().add(r.parse(a), "minutes")), a._z = r), a._z) if (e = a._z.utcOffset(a), Math.abs(e) < 16 && (e /= 60), void 0 !== a.utcOffset) {
      var o = a._z;
    ...
    if (a) {
      ...
      return this._z = _(a), this._z ? c.updateOffset(this, i) : O("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }
    ...
    return (e < 2 || 2 == e && r < 9) && O("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + c.version + "."), c.defaultZone = a ? _(a) : null, c;
  };
