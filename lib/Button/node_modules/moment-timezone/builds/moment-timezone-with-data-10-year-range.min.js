!function (a, i) {
  ...
  void 0 === A.version && A.default && (A = A.default);
  var i,
      c = {},
      n = {},
      t = {},
      s = {},
      u = {};
  A && "string" == typeof A.version || y("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/");
  ...
  function o(a) {
    ...
    for (45 === a.charCodeAt(0) && (n = -(i = 1)); i < r.length; i++) c = 60 * c + m(r.charCodeAt(i));

    for (i = 0; i < o.length; i++) A /= 60, c += m(o.charCodeAt(i)) * A;
  ...
  function p(a) {
    var i = a.split("|"),
        ...
        r = i[3].split(""),
        o = i[4].split(" ");
    return l(e), l(r), l(o), function (a, i) {
  ...
  function g() {
    for (var a, i, e = new Date().getFullYear() - 2, r = new d(new Date(e, 0, 1)), o = [r], A = 1; A < 48; A++) (i = new d(new Date(e, A, 1))).offset !== r.offset && (a = function (a, i) {
      for (var e, r; r = 6e4 * ((i.at - a.at) / 12e4 | 0);) (e = new d(new Date(a.at + r))).offset === a.offset ? a = e : i = e;

      return a;
    }(r, i), o.push(a), o.push(new d(new Date(a.at + 6e4)))), r = i;

    for (A = 0; A < 4; A++) o.push(new d(new Date(e + A, 0, 1))), o.push(new d(new Date(e + A, 6, 1)));
  ...
  function z() {
    ...
    for (var e, r, o = g(), A = o.length, c = function (a) {
      for (var i, e, r = a.length, o = {}, A = [], c = 0; c < r; c++) for (i in e = u[a[c].offset] || {}) e.hasOwnProperty(i) && (o[i] = !0);

      for (c in o) o.hasOwnProperty(c) && A.push(s[c]);

      return A;
    }(o), n = [], t = 0; t < c.length; t++) {
      for (e = new h(T(c[t])), r = 0; r < A; r++) e.scoreOffsetAt(o[r]);
  ...
  function S(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) o = P(e = (r = a[i].split("|"))[0]), c[o] = a[i], s[o] = e, function (a, i) {
      var e, r;

      for (l(i), e = 0; e < i.length; e++) r = i[e], u[r] = u[r] || {}, u[r][a] = !0;
    }(o, r[2].split(" "));
  }
  ...
  function T(a, i) {
    ...
    var e,
        r = c[a];
    return r instanceof M ? r : "string" == typeof r ? (r = new M(r), c[a] = r) : n[a] && i !== T && (e = T(n[a], T)) ? ((r = c[a] = new M())._set(e), r.name = s[a], r) : null;
  }
  ...
  function k(a) {
    S(a.zones), _(a.links), function (a) {
      var i, e, r, o;
      if (a && a.length) for (i = 0; i < a.length; i++) e = (o = a[i].split("|"))[0].toUpperCase(), r = o[1].split(" "), t[e] = new b(e, r);
    }(a.countries), O.dataVersion = a.version;
  }

  function B(a) {
    return B.didShowError || (B.didShowError = !0, y("moment.tz.zoneExists('" + a + "') has been deprecated in favor of !moment.tz.zone('" + a + "')")), !!T(a);
  }
  ...
  function O(a) {
    ...
    return r && !A.isMoment(a) && C(o) && o.add(r.parse(o), "minutes"), o.tz(e), o;
  }

  (e < 2 || 2 == e && r < 6) && y("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + A.version + ". See momentjs.com"), M.prototype = {
    _set: function (a) {
      this.name = a.name, this.abbrs = a.abbrs, this.untils = a.untils, this.offsets = a.offsets, this.population = a.population;
    },
    _index: function (a) {
      for (var i = +a, e = this.untils, r = 0; r < e.length; r++) if (i < e[r]) return r;
    },
    countries: function () {
      var i = this.name;
    ...
    parse: function (a) {
      for (var i, e, r, o = +a, A = this.offsets, c = this.untils, n = c.length - 1, t = 0; t < n; t++) if (i = A[t], e = A[t + 1], r = A[t ? t - 1 : t], i < e && O.moveAmbiguousForward ? i = e : r < i && O.moveInvalidForward && (i = r), o < c[t] - 6e4 * i) return A[t];
  ...
  }, O.version = "0.5.33", O.dataVersion = "", O._zones = c, O._links = n, O._names = s, O._countries = t, O.add = S, O.link = _, O.load = k, O.zone = T, O.zoneExists = B, O.guess = function (a) {
    return i && !a || (i = z()), i;
  }, O.names = function () {
    var a,
        i = [];

    for (a in s) s.hasOwnProperty(a) && (c[a] || c[n[a]]) && s[a] && i.push(s[a]);
  ...
  A.tz = O, A.defaultZone = null, A.updateOffset = function (a, i) {
    var e,
        r,
        o = A.defaultZone;
    void 0 === a._z && (o && C(a) && !a._isUTC && (a._d = A.utc(a._a)._d, a.utc().add(o.parse(a), "minutes")), a._z = o), a._z && (r = a._z.utcOffset(a), Math.abs(r) < 16 && (r /= 60), void 0 !== a.utcOffset ? (e = a._z, a.utcOffset(-r, i), a._z = e) : a.zone(r, i));
  }, L.tz = function (a, i) {
    if (a) {
      if ("string" != typeof a) throw new Error("Time zone name must be a string, got " + a + " [" + typeof a + "]");
      return this._z = T(a), this._z ? A.updateOffset(this, i) : y("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }

    if (this._z) return this._z.name;
  }, L.zoneName = D(L.zoneName), L.zoneAbbr = D(L.zoneAbbr), L.utc = v(L.utc), L.local = v(L.local), L.utcOffset = (N = L.utcOffset, function () {
    return 0 < arguments.length && (this._z = null), N.apply(this, arguments);
  }), A.tz.setDefault = function (a) {
    return (e < 2 || 2 == e && r < 9) && y("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + A.version + "."), A.defaultZone = a ? T(a) : null, A;
  };
