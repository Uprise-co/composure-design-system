!function (c, M) {
  ...
  function T(c) {
    ...
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) z = l(A = (o = c[M].split("|"))[0]), a[z] = c[M], i[z] = A, function (c, M) {
      var A, o;
  ...
  function t(c, M) {
    ...
    var A,
        o = a[c];
    return o instanceof N ? o : "string" == typeof o ? (o = new N(o), a[c] = o) : p[c] && M !== t && (A = t(p[c], t)) ? ((o = a[c] = new N())._set(A), o.name = i[c], o) : null;
  }

  function s(c) {
    var M, A, o, z;

    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) o = l((A = c[M].split("|"))[0]), z = l(A[1]), p[o] = z, i[o] = A[0], p[z] = o, i[z] = A[1];
  }
  ...
  function m(c) {
    return m.didShowError || (m.didShowError = !0, S("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")), !!t(c);
  }
  ...
  (A < 2 || 2 == A && o < 6) && S("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + b.version + ". See momentjs.com"), N.prototype = {
    ...
    parse: function (c) {
      for (var M, A, o, z = +c, b = this.offsets, a = this.untils, p = a.length - 1, n = 0; n < p; n++) if (M = b[n], A = b[n + 1], o = b[n ? n - 1 : n], M < A && R.moveAmbiguousForward ? M = A : o < M && R.moveInvalidForward && (M = o), z < a[n] - 6e4 * M) return b[n];
  ...
  }, R.version = "0.5.33", R.dataVersion = "", R._zones = a, R._links = p, R._names = i, R._countries = n, R.add = T, R.link = s, R.load = E, R.zone = t, R.zoneExists = m, R.guess = function (c) {
    return M && !c || (M = B()), M;
  }, R.names = function () {
    var c,
        M = [];
  ...
  b.tz = R, b.defaultZone = null, b.updateOffset = function (c, M) {
    var A,
        o,
        z = b.defaultZone;
    void 0 === c._z && (z && C(c) && !c._isUTC && (c._d = b.utc(c._a)._d, c.utc().add(z.parse(c), "minutes")), c._z = z), c._z && (o = c._z.utcOffset(c), Math.abs(o) < 16 && (o /= 60), void 0 !== c.utcOffset ? (A = c._z, c.utcOffset(-o, M), c._z = A) : c.zone(o, M));
  }, P.tz = function (c, M) {
    if (c) {
      if ("string" != typeof c) throw new Error("Time zone name must be a string, got " + c + " [" + typeof c + "]");
      return this._z = t(c), this._z ? b.updateOffset(this, M) : S("Moment Timezone has no data for " + c + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }
    ...
    return (A < 2 || 2 == A && o < 9) && S("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + b.version + "."), b.defaultZone = c ? t(c) : null, b;
  };
