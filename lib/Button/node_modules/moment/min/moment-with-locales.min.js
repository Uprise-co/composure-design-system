!function (e, a) {
  ...
  function A(e, a) {
    return e.isValid() ? (a = E(a, e.localeData()), O[a] = O[a] || function (s) {
      for (var e, n = s.match(j), a = 0, r = n.length; a < r; a++) P[n[a]] ? n[a] = P[n[a]] : n[a] = (e = n[a]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, "") : e.replace(/\\/g, "");
    ...
    }(a), O[a](e)) : e.localeData().invalidDate();
  }
  ...
  function K(e, a, t) {
    e.isValid() && !isNaN(t) && ("FullYear" === a && I(e.year()) && 1 === e.month() && 29 === e.date() ? (t = G(t), e._d["set" + (e._isUTC ? "UTC" : "") + a](t, e.month(), be(t, e.month()))) : e._d["set" + (e._isUTC ? "UTC" : "") + a](t));
  }
  ...
  function We(e, a) {
    ...
    return t = Math.min(e.date(), be(e.year(), a)), e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](a, t), e;
  }
  ...
  }), W(0, ["YYYY", 4], 0, "year"), W(0, ["YYYYY", 5], 0, "year"), W(0, ["YYYYYY", 6, !0], 0, "year"), z("year", "y"), C("year", 1), le("Y", ie), le("YY", ae, $), le("YYYY", re, X), le("YYYYY", de, ee), le("YYYYYY", de, ee), Le(["YYYYY", "YYYYYY"], fe), Le("YYYY", function (e, a) {
  ...
  function $e() {
    ...
    for (var a, t, s, n, r = [], d = [], _ = [], i = [], o = 0; o < 7; o++) a = c([2e3, 1]).day(o), t = he(this.weekdaysMin(a, "")), s = he(this.weekdaysShort(a, "")), n = he(this.weekdays(a, "")), r.push(t), d.push(s), _.push(n), i.push(t), i.push(s), i.push(n);

    r.sort(e), d.sort(e), _.sort(e), i.sort(e), this._weekdaysRegex = new RegExp("^(" + i.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = new RegExp("^(" + _.join("|") + ")", "i"), this._weekdaysShortStrictRegex = new RegExp("^(" + d.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + r.join("|") + ")", "i");
  }
  ...
  function ma(e, a) {
    ...
    if (a.abbr = e, null != na[e]) w("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), s = na[e]._config;else if (null != a.parentLocale) if (null != na[a.parentLocale]) s = na[a.parentLocale]._config;else {
      if (null == (t = ia(a.parentLocale))) return ra[a.parentLocale] || (ra[a.parentLocale] = []), ra[a.parentLocale].push({
        name: e,
        config: a
      }), null;
      s = t._config;
    }
    return na[e] = new b(H(s, a)), ra[e] && ra[e].forEach(function (e) {
      ma(e.name, e.config);
    }), oa(e), na[e];
  }
  ...
  function la(e) {
    var a,
        t = e._a;
    return t && -2 === L(e).overflow && (a = t[pe] < 0 || 11 < t[pe] ? pe : t[ke] < 1 || t[ke] > be(t[fe], t[pe]) ? ke : t[De] < 0 || 24 < t[De] || 24 === t[De] && (0 !== t[Te] || 0 !== t[ge] || 0 !== t[we]) ? De : t[Te] < 0 || 59 < t[Te] ? Te : t[ge] < 0 || 59 < t[ge] ? ge : t[we] < 0 || 999 < t[we] ? we : -1, L(e)._overflowDayOfYear && (a < fe || ke < a) && (a = ke), L(e)._overflowWeeks && -1 === a && (a = ve), L(e)._overflowWeekday && -1 === a && (a = He), L(e).overflow = a), e;
  }
  ...
  function ka(e) {
    ...
    if (i) {
      for (L(e).iso = !0, a = 0, t = La.length; a < t; a++) if (La[a][1].exec(i[1])) {
        n = La[a][0], s = !1 !== La[a][2];
        break;
      }
  ...
  function wa(e) {
    ...
    if (!e._d) {
      for (d = e, _ = new Date(M.now()), s = d._useUTC ? [_.getUTCFullYear(), _.getUTCMonth(), _.getUTCDate()] : [_.getFullYear(), _.getMonth(), _.getDate()], e._w && null == e._a[ke] && null == e._a[pe] && function (e) {
        var a, t, s, n, r, d, _, i, o;

        null != (a = e._w).GG || null != a.W || null != a.E ? (r = 1, d = 4, t = ga(a.GG, e._a[fe], Ce(Sa(), 1, 4).year), s = ga(a.W, 1), ((n = ga(a.E, 1)) < 1 || 7 < n) && (i = !0)) : (r = e._locale._week.dow, d = e._locale._week.doy, o = Ce(Sa(), r, d), t = ga(a.gg, e._a[fe], o.year), s = ga(a.w, o.week), null != a.d ? ((n = a.d) < 0 || 6 < n) && (i = !0) : null != a.e ? (n = a.e + r, (a.e < 0 || 6 < a.e) && (i = !0)) : n = r);
        s < 1 || s > Ie(t, r, d) ? L(e)._overflowWeeks = !0 : null != i ? L(e)._overflowWeekday = !0 : (_ = Re(t, s, n, r, d), e._a[fe] = _.year, e._dayOfYear = _.dayOfYear);
      }(e), null != e._dayOfYear && (r = ga(e._a[fe], s[fe]), (e._dayOfYear > Fe(r) || 0 === e._dayOfYear) && (L(e)._overflowDayOfYear = !0), t = Ne(r, 0, e._dayOfYear), e._a[pe] = t.getUTCMonth(), e._a[ke] = t.getUTCDate()), a = 0; a < 3 && null == e._a[a]; ++a) e._a[a] = i[a] = s[a];
      ...
      }).apply(null, i), n = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[De] = 24), e._w && void 0 !== e._w.d && e._w.d !== n && (L(e).weekdayMismatch = !0);
    }
  }
  ...
  function va(e) {
    if (e._f !== M.ISO_8601) {
      if (e._f !== M.RFC_2822) {
        ...
        for (var a, t, s, n, r, d, _, i = "" + e._i, o = i.length, m = 0, u = E(e._f, e._locale).match(j) || [], l = 0; l < u.length; l++) t = u[l], (a = (i.match(Me(t, e)) || [])[0]) && (0 < (s = i.substr(0, i.indexOf(a))).length && L(e).unusedInput.push(s), i = i.slice(i.indexOf(a) + a.length), m += a.length), P[t] ? (a ? L(e).empty = !1 : L(e).unusedTokens.push(t), r = t, _ = e, null != (d = a) && h(ce, r) && ce[r](d, _._a, _, r)) : e._strict && !a && L(e).unusedTokens.push(t);

        L(e).charsLeftOver = o - m, 0 < i.length && L(e).unusedInput.push(i), e._a[De] <= 12 && !0 === L(e).bigHour && 0 < e._a[De] && (L(e).bigHour = void 0), L(e).parsedDateParts = e._a.slice(0), L(e).meridiem = e._meridiem, e._a[De] = function (e, a, t) {
          var s;
          if (null == t) return a;
  ...
  function Ha(e) {
    ...
    return e._locale = e._locale || ua(e._l), null === s || void 0 === n && "" === s ? y({
      nullInput: !0
    }) : ("string" == typeof s && (e._i = s = e._locale.preparse(s)), D(s) ? new k(la(s)) : (d(s) ? e._d = s : _(n) ? function (e) {
      var a,
          t,
          s,
          n,
      ...
      for (n = 0; n < e._f.length; n++) r = 0, d = !1, a = p({}, e), null != e._useUTC && (a._useUTC = e._useUTC), a._f = e._f[n], va(a), Y(a) && (d = !0), r += L(a).charsLeftOver, r += 10 * L(a).unusedTokens.length, L(a).score = r, _ ? r < s && (s = r, t = a) : (null == s || r < s || d) && (s = r, t = a, d && (_ = !0));
    ...
    }(a) : _(t) ? (a._a = u(t.slice(0), function (e) {
  ...
  function ba(e, a, t, s, n) {
    var r,
        d = {};
    return !0 !== a && !1 !== a || (s = a, a = void 0), !0 !== t && !1 !== t || (s = t, t = void 0), (i(e) && o(e) || _(e) && 0 === e.length) && (e = void 0), d._isAMomentObject = !0, d._useUTC = d._isUTC = n, d._l = t, d._i = e, d._f = a, d._strict = s, (r = new k(la(Ha(d))))._nextDay && (r.add(1, "d"), r._nextDay = void 0), r;
  }
  ...
  var Pa = ["year", "quarter", "month", "week", "day", "hour", "minute", "second", "millisecond"];
  ...
  function Wa(e) {
    ...
    this._isValid = function (e) {
      ...
      for (a in e) if (h(e, a) && (-1 === ye.call(Pa, a) || null != e[a] && isNaN(e[a]))) return !1;

      for (t = 0; t < Pa.length; ++t) if (e[Pa[t]]) {
        if (s) return !1;
        parseFloat(e[Pa[t]]) !== G(e[Pa[t]]) && (s = !0);
      }

      return !0;
    }(a), this._milliseconds = +m + 1e3 * o + 6e4 * i + 1e3 * _ * 60 * 60, this._days = +d + 7 * r, this._months = +n + 3 * s + 12 * t, this._data = {}, this._locale = ua(), this._bubble();
  }
  ...
  function Fa(e, t) {
    W(e, 0, 0, function () {
      var e = this.utcOffset(),
          a = "+";
      return e < 0 && (e = -e, a = "-"), a + S(~~(e / 60), 2) + t + S(~~e % 60, 2);
    });
  }
  ...
  function Ja(e, a) {
    var t, s;
    return a._isUTC ? (t = a.clone(), s = (D(e) || d(e) ? e.valueOf() : Sa(e).valueOf()) - t.valueOf(), t._d.setTime(t._d.valueOf() + s), M.updateOffset(t, !1), t) : Sa(e).local();
  }
  ...
  function Ga(e, a) {
    ...
    return Aa(e) ? r = {
      ...
      return t;
    }(Sa(r.from), Sa(r.to)), (r = {}).ms = n.milliseconds, r.M = n.months), s = new Wa(r), Aa(e) && h(e, "_locale") && (s._locale = e._locale), Aa(e) && h(e, "_isValid") && (s._isValid = e._isValid), s;
  }
  ...
  W("N", 0, 0, "eraAbbr"), W("NN", 0, 0, "eraAbbr"), W("NNN", 0, 0, "eraAbbr"), W("NNNN", 0, 0, "eraName"), W("NNNNN", 0, 0, "eraNarrow"), W("y", ["y", 1], "yo", "eraYear"), W("y", ["yy", 2], 0, "eraYear"), W("y", ["yyy", 3], 0, "eraYear"), W("y", ["yyyy", 4], 0, "eraYear"), le("N", it), le("NN", it), le("NNN", it), le("NNNN", function (e, a) {
  ...
  }), le("y", _e), le("yy", _e), le("yyy", _e), le("yyyy", _e), le("yo", function (e, a) {
  ...
  }), mt("gggg", "weekYear"), mt("ggggg", "weekYear"), mt("GGGG", "isoWeekYear"), mt("GGGGG", "isoWeekYear"), z("weekYear", "gg"), z("isoWeekYear", "GG"), C("weekYear", 1), C("isoWeekYear", 1), le("G", ie), le("g", ie), le("GG", ae, $), le("gg", ae, $), le("GGGG", re, X), le("gggg", re, X), le("GGGGG", de, ee), le("ggggg", de, ee), Ye(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, a, t, s) {
    a[s.substr(0, 2)] = G(e);
  ...
  }), z("millisecond", "ms"), C("millisecond", 16), le("S", ne, Z), le("SS", ne, $), le("SSS", ne, Q), ht = "SSSS"; ht.length <= 9; ht += "S") le(ht, _e);
  ...
  yt.add = Za, yt.calendar = function (e, a) {
    1 === arguments.length && (Xa(arguments[0]) ? (e = arguments[0], a = void 0) : function (e) {
    ...
    return this.isValid() && (D(e) && e.isValid() || Sa(e).isValid()) ? Ga({
      to: this,
      from: e
    ...
    }(e = J(e)), s = 0; s < t.length; s++) this[t[s].unit](e[t[s].unit]);else if (v(this[e = N(e)])) return this[e](a);
    return this;
    ...
    for (var e, a = this.localeData().eras(), t = 0, s = a.length; t < s; ++t) {
      if (e = this.startOf("day").valueOf(), a[t].since <= e && e <= a[t].until) return a[t].name;
    ...
    for (var e, a = this.localeData().eras(), t = 0, s = a.length; t < s; ++t) {
      if (e = this.startOf("day").valueOf(), a[t].since <= e && e <= a[t].until) return a[t].narrow;
    ...
    for (var e, a = this.localeData().eras(), t = 0, s = a.length; t < s; ++t) {
      if (e = this.startOf("day").valueOf(), a[t].since <= e && e <= a[t].until) return a[t].abbr;
      if (a[t].until <= e && e <= a[t].since) return a[t].abbr;
    }

    return "";
  }, yt.eraYear = function () {
    for (var e, a, t = this.localeData().eras(), s = 0, n = t.length; s < n; ++s) if (e = t[s].since <= t[s].until ? 1 : -1, a = this.startOf("day").valueOf(), t[s].since <= a && a <= t[s].until || t[s].until <= a && a <= t[s].since) return (this.year() - M(t[s].since).year()) * e + t[s].offset;
    ...
    var e,
        a = {};
    return p(a, this), (a = Ha(a))._a ? (e = (a._isUTC ? c : Sa)(a._a), this._isDSTShifted = this.isValid() && 0 < function (e, a, t) {
  ...
  pt.calendar = function (e, a, t) {
    ...
    for (e = e.toUpperCase(), s = 0, n = i.length; s < n; ++s) if (r = i[s].name.toUpperCase(), d = i[s].abbr.toUpperCase(), _ = i[s].narrow.toUpperCase(), t) switch (a) {
      case "N":
      case "NN":
      case "NNN":
        if (d === e) return i[s];
    ...
    return this._monthsParseExact ? (h(this, "_monthsRegex") || Ee.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (h(this, "_monthsRegex") || (this._monthsRegex = Pe), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
  }, pt.monthsShortRegex = function (e) {
    return this._monthsParseExact ? (h(this, "_monthsRegex") || Ee.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (h(this, "_monthsShortRegex") || (this._monthsShortRegex = Oe), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
  }, pt.week = function (e) {
  ...
  function Qt() {
    ...
    return u ? (e = U(i / 60), a = U(e / 60), i %= 60, e %= 60, t = U(m / 12), m %= 12, s = i ? i.toFixed(3).replace(/\.?0+$/, "") : "", n = u < 0 ? "-" : "", r = $t(this._months) !== $t(u) ? "-" : "", d = $t(this._days) !== $t(u) ? "-" : "", _ = $t(this._milliseconds) !== $t(u) ? "-" : "", n + "P" + (t ? r + t + "Y" : "") + (m ? r + m + "M" : "") + (o ? d + o + "D" : "") + (a || e || i ? "T" : "") + (a ? _ + a + "H" : "") + (e ? _ + e + "M" : "") + (i ? _ + s + "S" : "")) : "P0D";
  }
  ...
  Xt.isValid = function () {
    ...
    if ("month" === (e = N(e)) || "quarter" === e || "year" === e) switch (a = this._days + s / 864e5, t = this._months + Ht(a), e) {
      case "month":
        return t;
      ...
      case "year":
        return t / 12;
    } else switch (a = this._days + Math.round(bt(this._months)), e) {
      case "week":
        return a / 7 + s / 6048e5;
  ...
  }, Xt.asMilliseconds = jt, Xt.asSeconds = xt, Xt.asMinutes = Ot, Xt.asHours = Pt, Xt.asDays = Wt, Xt.asWeeks = At, Xt.asMonths = Et, Xt.asQuarters = Ft, Xt.asYears = zt, Xt.valueOf = function () {
    ...
    var e,
        ...
        _ = this._months,
        i = this._data;
    return 0 <= r && 0 <= d && 0 <= _ || r <= 0 && d <= 0 && _ <= 0 || (r += 864e5 * vt(bt(_) + d), _ = d = 0), i.milliseconds = r % 1e3, e = U(r / 1e3), i.seconds = e % 60, a = U(e / 60), i.minutes = a % 60, t = U(a / 60), i.hours = t % 24, d += U(t / 24), _ += n = U(Ht(d)), d -= vt(bt(n)), s = U(_ / 12), _ %= 12, i.days = d, i.months = _, i.years = s, this;
  }, Xt.clone = function () {
    return Ga(this);
  }, Xt.get = function (e) {
  ...
  }, Xt.toISOString = Qt, Xt.toString = Qt, Xt.toJSON = Qt, Xt.locale = at, Xt.localeData = st, Xt.toIsoString = t("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Qt), Xt.lang = tt, W("X", 0, 0, "unix"), W("x", 0, 0, "valueOf"), le("x", ie), le("X", /[+-]?\d+(\.\d{1,3})?/), Le("X", function (e, a, t) {
    t._d = new Date(1e3 * parseFloat(e));
  }), Le("x", function (e, a, t) {
    t._d = new Date(G(e));
  }), M.version = "2.26.0", e = Sa, M.fn = yt, M.min = function () {
    ...
    var t, s, n;
    return null != a ? (n = sa, null != na[e] && null != na[e].parentLocale ? na[e].set(H(na[e]._config, a)) : (null != (s = ia(e)) && (n = s._config), a = H(n, a), null == s && (a.abbr = e), (t = new b(a)).parentLocale = na[e], na[e] = t), oa(e)) : null != na[e] && (null != na[e].parentLocale ? (na[e] = na[e].parentLocale, e === oa() && oa(e)) : null != na[e] && delete na[e]), na[e];
  }, M.locales = function () {
    return s(na);
  ...
  var ds = {
    ...
    y: ["\u0623\u0642\u0644 \u0645\u0646 \u0639\u0627\u0645", "\u0639\u0627\u0645 \u0648\u0627\u062d\u062f", ["\u0639\u0627\u0645\u0627\u0646", "\u0639\u0627\u0645\u064a\u0646"], "%d \u0623\u0639\u0648\u0627\u0645", "%d \u0639\u0627\u0645\u064b\u0627", "%d \u0639\u0627\u0645"]
      ...
      is = ["\u064a\u0646\u0627\u064a\u0631", "\u0641\u0628\u0631\u0627\u064a\u0631", "\u0645\u0627\u0631\u0633", "\u0623\u0628\u0631\u064a\u0644", "\u0645\u0627\u064a\u0648", "\u064a\u0648\u0646\u064a\u0648", "\u064a\u0648\u0644\u064a\u0648", "\u0623\u063a\u0633\u0637\u0633", "\u0633\u0628\u062a\u0645\u0628\u0631", "\u0623\u0643\u062a\u0648\u0628\u0631", "\u0646\u0648\u0641\u0645\u0628\u0631", "\u062f\u064a\u0633\u0645\u0628\u0631"];
  ...
  var gs = [/^gen/i, /^c[\u02bc\']hwe/i, /^meu/i, /^ebr/i, /^mae/i, /^(mez|eve)/i, /^gou/i, /^eos/i, /^gwe/i, /^her/i, /^du/i, /^ker/i],
  ...
  var bs = "leden_\xfanor_b\u0159ezen_duben_kv\u011bten_\u010derven_\u010dervenec_srpen_z\xe1\u0159\xed_\u0159\xedjen_listopad_prosinec".split("_"),
      Ss = "led_\xfano_b\u0159e_dub_kv\u011b_\u010dvn_\u010dvc_srp_z\xe1\u0159_\u0159\xedj_lis_pro".split("_"),
      js = [/^led/i, /^\xfano/i, /^b\u0159e/i, /^dub/i, /^kv\u011b/i, /^(\u010dvn|\u010derven$|\u010dervna)/i, /^(\u010dvc|\u010dervenec|\u010dervence)/i, /^srp/i, /^z\xe1\u0159/i, /^\u0159\xedj/i, /^lis/i, /^pro/i],
  ...
  function Ps(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "MM":
        return a || s ? n + (Os(e) ? "m\u011bs\xedce" : "m\u011bs\xedc\u016f") : n + "m\u011bs\xedci";
  ...
  var Ns = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
  ...
  var Is = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
      ...
      Gs = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i],
  ...
  var en = "nolla yksi kaksi kolme nelj\xe4 viisi kuusi seitsem\xe4n kahdeksan yhdeks\xe4n".split(" "),
      an = ["nolla", "yhden", "kahden", "kolmen", "nelj\xe4n", "viiden", "kuuden", en[7], en[8], en[9]];
  ...
  var sn = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"),
      nn = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");
  M.defineLocale("fy", {
    months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),
    monthsShort: function (e, a) {
      return e ? /-MMM-/.test(a) ? nn[e.month()] : sn[e.month()] : sn;
    },
    monthsParseExact: !0,
  ...
  var Mn = "vas\xe1rnap h\xe9tf\u0151n kedden szerd\xe1n cs\xfct\xf6rt\xf6k\xf6n p\xe9nteken szombaton".split(" ");
  ...
  function cn(e) {
    return (e ? "" : "[m\xfalt] ") + "[" + Mn[this.day()] + "] LT[-kor]";
  }
  ...
  function Yn(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return Ln(e) ? n + (a || s ? "sek\xfandur" : "sek\xfandum") : n + "sek\xfanda";

      case "m":
        return a ? "m\xedn\xfata" : "m\xedn\xfatu";

      case "mm":
        return Ln(e) ? n + (a || s ? "m\xedn\xfatur" : "m\xedn\xfatum") : a ? n + "m\xedn\xfata" : n + "m\xedn\xfatu";

      case "hh":
        return Ln(e) ? n + (a || s ? "klukkustundir" : "klukkustundum") : n + "klukkustund";

      case "d":
        return a ? "dagur" : s ? "dag" : "degi";

      case "dd":
        return Ln(e) ? a ? n + "dagar" : n + (s ? "daga" : "d\xf6gum") : a ? n + "dagur" : n + (s ? "dag" : "degi");

      case "M":
        return a ? "m\xe1nu\xf0ur" : s ? "m\xe1nu\xf0" : "m\xe1nu\xf0i";

      case "MM":
        return Ln(e) ? a ? n + "m\xe1nu\xf0ir" : n + (s ? "m\xe1nu\xf0i" : "m\xe1nu\xf0um") : a ? n + "m\xe1nu\xf0ur" : n + (s ? "m\xe1nu\xf0" : "m\xe1nu\xf0i");

      case "y":
        return a || s ? "\xe1r" : "\xe1ri";

      case "yy":
        return Ln(e) ? n + (a || s ? "\xe1r" : "\xe1rum") : n + (a || s ? "\xe1r" : "\xe1ri");
    }
  }
  ...
  M.defineLocale("hu", {
    ...
    calendar: {
      ...
      nextWeek: function () {
        return cn.call(this, !0);
      },
      lastDay: "[tegnap] LT[-kor]",
      lastWeek: function () {
        return cn.call(this, !1);
      },
      sameElse: "L"
    },
    relativeTime: {
  ...
  M.defineLocale("kk", {
    ...
    ordinal: function (e) {
      return e + (yn[e] || yn[e % 10] || yn[100 <= e ? 100 : null]);
    },
    week: {
      dow: 1,
      doy: 7
  ...
  M.defineLocale("ky", {
    ...
    relativeTime: {
      future: function (e) {
        return bn(e.substr(0, e.indexOf(" "))) ? "a " + e : "an " + e;
      },
      past: function (e) {
        return bn(e.substr(0, e.indexOf(" "))) ? "viru " + e : "virun " + e;
      },
      s: "e puer Sekonnen",
      ss: "%d Sekonnen",
      m: Hn,
  ...
  function jn(e, a, t, s) {
    return a ? On(t)[0] : s ? On(t)[1] : On(t)[2];
  }
  ...
  function Pn(e, a, t, s) {
    var n = e + " ";
    return 1 === e ? n + jn(0, a, t[0], s) : a ? n + (xn(e) ? On(t)[1] : On(t)[0]) : s ? n + On(t)[1] : n + (xn(e) ? On(t)[1] : On(t)[2]);
  }
  ...
  var Bn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
      Kn = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"),
      qn = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i],
      Zn = /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
  M.defineLocale("nl-be", {
    months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
    monthsShort: function (e, a) {
      return e ? /-MMM-/.test(a) ? Kn[e.month()] : Bn[e.month()] : Bn;
    },
    monthsRegex: Zn,
    monthsShortRegex: Zn,
  ...
  var $n = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
      Qn = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"),
      Xn = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i],
      er = /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
  M.defineLocale("nl", {
    months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
    monthsShort: function (e, a) {
      return e ? /-MMM-/.test(a) ? Qn[e.month()] : $n[e.month()] : $n;
    },
    monthsRegex: er,
    monthsShortRegex: er,
    monthsStrictRegex: /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december)/i,
  ...
  var sr = "stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144".split("_"),
      nr = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrze\u015bnia_pa\u017adziernika_listopada_grudnia".split("_");
  ...
  function dr(e, a, t) {
    ...
    switch (t) {
      case "ss":
        return s + (rr(e) ? "sekundy" : "sekund");

      case "m":
        return a ? "minuta" : "minut\u0119";

      case "mm":
        return s + (rr(e) ? "minuty" : "minut");

      case "h":
        return a ? "godzina" : "godzin\u0119";

      case "hh":
        return s + (rr(e) ? "godziny" : "godzin");

      case "MM":
        return s + (rr(e) ? "miesi\u0105ce" : "miesi\u0119cy");

      case "yy":
        return s + (rr(e) ? "lata" : "lat");
    }
  }
  ...
  M.defineLocale("pl", {
    months: function (e, a) {
      return e ? "" === a ? "(" + nr[e.month()] + "|" + sr[e.month()] + ")" : /D MMMM/.test(a) ? nr[e.month()] : sr[e.month()] : sr;
    },
  ...
  var or = [/^\u044f\u043d\u0432/i, /^\u0444\u0435\u0432/i, /^\u043c\u0430\u0440/i, /^\u0430\u043f\u0440/i, /^\u043c\u0430[\u0439\u044f]/i, /^\u0438\u044e\u043d/i, /^\u0438\u044e\u043b/i, /^\u0430\u0432\u0433/i, /^\u0441\u0435\u043d/i, /^\u043e\u043a\u0442/i, /^\u043d\u043e\u044f/i, /^\u0434\u0435\u043a/i];
  M.defineLocale("ru", {
    months: {
  ...
  var mr = ["\u062c\u0646\u0648\u0631\u064a", "\u0641\u064a\u0628\u0631\u0648\u0631\u064a", "\u0645\u0627\u0631\u0686", "\u0627\u067e\u0631\u064a\u0644", "\u0645\u0626\u064a", "\u062c\u0648\u0646", "\u062c\u0648\u0644\u0627\u0621\u0650", "\u0622\u06af\u0633\u067d", "\u0633\u064a\u067e\u067d\u0645\u0628\u0631", "\u0622\u06aa\u067d\u0648\u0628\u0631", "\u0646\u0648\u0645\u0628\u0631", "\u068a\u0633\u0645\u0628\u0631"],
      ur = ["\u0622\u0686\u0631", "\u0633\u0648\u0645\u0631", "\u0627\u06b1\u0627\u0631\u0648", "\u0627\u0631\u0628\u0639", "\u062e\u0645\u064a\u0633", "\u062c\u0645\u0639", "\u0687\u0646\u0687\u0631"];
  M.defineLocale("sd", {
    months: mr,
    monthsShort: mr,
    weekdays: ur,
  ...
  var lr = "janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december".split("_"),
      Mr = "jan_feb_mar_apr_m\xe1j_j\xfan_j\xfal_aug_sep_okt_nov_dec".split("_");
  ...
  function cr(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return a || s ? n + (hr(e) ? "sekundy" : "sek\xfand") : n + "sekundami";

      case "m":
        return a ? "min\xfata" : s ? "min\xfatu" : "min\xfatou";

      case "mm":
        return a || s ? n + (hr(e) ? "min\xfaty" : "min\xfat") : n + "min\xfatami";

      case "h":
        return a ? "hodina" : s ? "hodinu" : "hodinou";

      case "hh":
        return a || s ? n + (hr(e) ? "hodiny" : "hod\xedn") : n + "hodinami";

      case "d":
        return a || s ? "de\u0148" : "d\u0148om";

      case "dd":
        return a || s ? n + (hr(e) ? "dni" : "dn\xed") : n + "d\u0148ami";

      case "M":
        return a || s ? "mesiac" : "mesiacom";

      case "MM":
        return a || s ? n + (hr(e) ? "mesiace" : "mesiacov") : n + "mesiacmi";

      case "y":
        return a || s ? "rok" : "rokom";

      case "yy":
        return a || s ? n + (hr(e) ? "roky" : "rokov") : n + "rokmi";
    }
  }
  ...
  var Yr = {
    ...
    translate: function (e, a, t) {
      var s = Yr.words[t];
      return 1 === t.length ? a ? s[0] : s[1] : e + " " + Yr.correctGrammaticalCase(e, s);
    }
  };
  ...
  M.defineLocale("tg", {
    ...
    ordinal: function (e) {
      return e + (kr[e] || kr[e % 10] || kr[100 <= e ? 100 : null]);
    },
    week: {
      dow: 1,
      doy: 7
  ...
  var Dr = "pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
    ...
    calendar: {
      ...
      lastWeek: function () {
        switch (this.day()) {
          ...
          case 5:
          case 6:
            return Hr("[\u041c\u0438\u043d\u0443\u043b\u043e\u0457] dddd [").call(this);

          case 1:
          case 2:
          case 4:
            return Hr("[\u041c\u0438\u043d\u0443\u043b\u043e\u0433\u043e] dddd [").call(this);
        }
      },
      sameElse: "L"
    },
  ...
  var br = ["\u062c\u0646\u0648\u0631\u06cc", "\u0641\u0631\u0648\u0631\u06cc", "\u0645\u0627\u0631\u0686", "\u0627\u067e\u0631\u06cc\u0644", "\u0645\u0626\u06cc", "\u062c\u0648\u0646", "\u062c\u0648\u0644\u0627\u0626\u06cc", "\u0627\u06af\u0633\u062a", "\u0633\u062a\u0645\u0628\u0631", "\u0627\u06a9\u062a\u0648\u0628\u0631", "\u0646\u0648\u0645\u0628\u0631", "\u062f\u0633\u0645\u0628\u0631"],
      Sr = ["\u0627\u062a\u0648\u0627\u0631", "\u067e\u06cc\u0631", "\u0645\u0646\u06af\u0644", "\u0628\u062f\u06be", "\u062c\u0645\u0639\u0631\u0627\u062a", "\u062c\u0645\u0639\u06c1", "\u06c1\u0641\u062a\u06c1"];
