...
import { backgrounds, extended, primary } from "uprise-uikit/colors"; // spacing
...
export const List = ({
  ...
  return (
    /*#__PURE__*/
    React.createElement(ListStyles, props, items.map((item, index) => {
      return (
        /*#__PURE__*/
        React.createElement(ItemStyles, {
          key: index
        }, item.title)
      );
    }))
