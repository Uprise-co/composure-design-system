...
const ProgressItem = ({
  ...
  return (
    /*#__PURE__*/
    React.createElement(ProgressItemStyles, {
      active: active
    }, children)
  );
};
...
export const VerticalProgress = ({
  ...
  return (
    /*#__PURE__*/
    React.createElement(ProgressStyles, props, items.map((item, index) => {
      return (
        /*#__PURE__*/
        React.createElement(ProgressItem, {
          key: index,
          active: item.active
        },
        /*#__PURE__*/
        React.createElement(Fragment, null, item.active &&
        /*#__PURE__*/
        React.createElement(OvalActiveStyles, {
          last: index === items.length - 1
        }), !item.active &&
        /*#__PURE__*/
        React.createElement(OvalStyles, {
          last: index === items.length - 1
        }),
        /*#__PURE__*/
